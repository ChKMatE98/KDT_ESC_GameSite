...
<body class="bg-light">
                ...
                <ul class="headerul">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <li class="headerli"><a class="showBoardList" href="#" onclick='showBoardList()'>게시판</a></li>
                        ...
                        <c:when test="${empty sessionScope.loginID}">
                            <div class="col-12 g-0">
                                <form action="/login.members" method="post">
                                    <div class="loginbox">
                                        <div class="idlogin">
                                            <i class="fa-regular fa-user"></i> <input type="text" placeholder="아이디" id="id" class="inputlogin" name="id" />
                                        </div>

                                        <div class="pwlogin">
                                            <i class="fa-solid fa-lock"></i> <input type="password" placeholder="비밀번호" class="inputpw" name="pw" />
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <ul class="findelement">
                                                    <a href="/membership/findMyId.jsp">
                                                        <li>아이디 찾기</li>
                                                    </a>
                                                    <a href="/membership/findMyPw.jsp">
                                                        <li>비밀번호 찾기</li>
                                                    </a>
    ...
    <c:choose>
        <c:when test="${empty searchText}">
            <div class="searchresultText">공지게시판</div>
        </c:when>
        <c:otherwise>
        ...
        <div class="body">
            <div class="row">
                <div class="boardheader col-12 col-sm-12">
                    <div class="row">
                        <div class="col-12 col-sm-1 d-none d-sm-block text-center">번호</div>
                        <div class="col-12 col-sm-4 text-center text-sm-start">제목</div>
                        <div class="col-12 col-sm-3 d-none d-sm-block text-center">작성자</div>
                        <div class="col-12 col-sm-1 d-none d-sm-block text-center">조회</div>
                        ...
                        <div class="col-12 c">
                            <div class="row contents">
                                ...
                                <div class="nav col-12 col-sm-4 ">
                                    <a href="/showContents.adminboard?title=${i.title}&seq=${i.seq}&searchText=${searchText}" onclick="return checkLoginAndRedirect();" style="color: #000000;">${i.title}</a>
                                </div>
            ...
            <div class="buttonbox">
                <c:choose>
                    <c:when test="${isadmin eq 1}">
                        <button type="button" class="mpbtn btn-primary col-12 col-sm-2 m-2" id="write">작성하기</button>
                        <button type="button" class="mpbtn btn-primary col-12 col-sm-2 m-2" id="back">돌아가기</button>
                    </c:when>
                    <c:otherwise>
                        <button type="button" class="mpbtn btn-primary col-12 col-sm-2 m-2" id="back">돌아가기</button>
                    </c:otherwise>
