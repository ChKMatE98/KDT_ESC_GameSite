...
<head>
    ...
    <title>Skeleton Survivor</title>
    <link rel="bigcut icon" href="asset/img/skull.png" />
    ...
    <script src="./asset/js/gamestartscene.js"></script>
    <script src="./asset/js/gamescene.js"></script>
    <script src="./asset/js/gameoverscene.js"></script>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="explanation">
                        <br>
                        <p>다섯 번 동안 적에게 닿지 않으면서 적을 처치해 나가는 게임입니다.</p>
                        <p>이동 : 방향키</p>
                        <p>공격 : 스페이스 바</p>
                        <p>공전하는 해골 : 적에게 닿으면 데미지를 입히며 2초마다 한번 씩 생성됩니다.</p>
                        <p>------------------------------------- 단계마다 적들이 빨라집니다.
                            ------------------------------------- </p>
                        <p>대각선으로 이동은 가능하나 대각선 방향의 공격은 불가능합니다 </p>
                    </div>
                </div>
            </div>
        </div>
